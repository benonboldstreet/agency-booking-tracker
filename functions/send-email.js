/**
 * Standalone serverless function for dispatching confirmation emails.
 * Supports modern Node.js global fetch.
 */
exports.handler = async (event) => {
  ...
  try {
    ...
    console.error("Critical error in send-email alternative function:", err);
    return {
      statusCode: 500,
      headers: { "Content-Type": "application/json" },
